...
WowKeysLayout = {
  ...
  buttons = {
    ...
    { slot = 190, spell = "Ice Block" },
    { slot = 191, macro = "HealthPot" },
    { slot = 192, spell = "Cone of Cold" },
    ...
    { slot = 208, macro = "ManaPot" },
    { slot = 209, spell = "Conjure Food" },
    { slot = 210, macro = "Drink" },
    { slot = 211, macro = "Eat" },
    { slot = 212, spell = "Conjure Water" },
    { slot = 221, macro = "Mount" },
    { slot = 222, spell = "Frost Armor" },
    { slot = 223, spell = "Arcane Intellect" },
    { slot = 224, macro = "Hearth" },
  },
  macros = {
